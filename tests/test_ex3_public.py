...
def test_imports_0():
    from rl2020.exercise3 import DQN, Reinforce, ReplayBuffer
    ...
    from rl2020.exercise3.train_reinforce import CARTPOLE_CONFIG as REINF_CARTPOLE_CONFIG
    from rl2020.exercise3.train_reinforce import LUNARLANDER_CONFIG as REINF_LUNARLANDER_CONFIG
...
def test_restore_file_0():
    from rl2020.exercise3 import DQN
    from rl2020.exercise3.train_dqn import LUNARLANDER_CONFIG as DQN_LUNARLANDER_CONFIG
...
def test_restore_file_1():
    from rl2020.exercise3 import Reinforce
    from rl2020.exercise3.train_reinforce import LUNARLANDER_CONFIG as REINF_LUNARLANDER_CONFIG
    env = gym.make("LunarLander-v2")
    agent = Reinforce(
        action_space=env.action_space,
        observation_space=env.observation_space,
        **REINF_LUNARLANDER_CONFIG
    )
    agent.restore("reinf_lunarlander_latest.pt")
